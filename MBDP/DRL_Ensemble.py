...
def main():
    ...
    kwargs = {
        ...
        "train_start": "2015-06-01", "train_end": "2015-12-31",
        "test_start": "2016-01-01", "test_end": "2020-05-08",
    }

    lag_sets = generate_random_lag_sets(n_sets=100, min_lags=2, max_lags=2, min_lag_val=1, max_lag_val=30)
